...
![Testate runs in Docker on the DEV, SIT, or UAT server next to the main service and its database; a reverse proxy exposes it to admins, viewers, testers, CI/CD, and AI agents](docs/assets/banner.svg)
