...
| Projects | `GET /projects`, `POST /projects`, `GET /projects/defaults`, `GET /projects/{slug}`, `PATCH`, `GET .../head`, `GET .../quota`, `GET .../deletion-plan`, `POST .../deletion` | OK |
| Adapters | `GET /adapter-hosts`, `GET /storage-adapters`, `GET .../adapters`, `POST .../adapters/test`, `POST .../adapters`, `GET .../adapters/{id}`, `PATCH`, `POST .../mode`, `POST .../retest`, `GET .../deletion-plan`, `POST .../deletion` | OK (probes real on Postgres, MySQL/MariaDB, MongoDB, S3, SFTP, FTP) |
