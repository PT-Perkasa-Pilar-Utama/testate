...
`docker compose -f deploy/compose.engines.yml up -d` starts PostgreSQL (15432), MySQL (13306), MariaDB (13307), MongoDB (17017), and MinIO (9000) with user `testate` / password `testate`. Not for production.
